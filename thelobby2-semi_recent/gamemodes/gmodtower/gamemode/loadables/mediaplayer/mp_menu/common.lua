...
function VOTE_SKIP_BTN:Init()
	self.BaseClass.Init( self )
	self:SetIcon( "mp-thumbs-down" )
end

function VOTE_SKIP_BTN:DoClick()
	hook.Run( MP.EVENTS.UI.VOTE_SKIP )
end

derma.DefineControl( "MP.VoteSkipButton", "", VOTE_SKIP_BTN, "MP.SidebarButton" )
