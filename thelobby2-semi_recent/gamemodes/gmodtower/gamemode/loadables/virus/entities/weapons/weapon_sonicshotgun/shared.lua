...
SWEP.Secondary.Sound		= { "GModTower/virus/weapons/SonicDispersionShotgun/alt_shoot1.wav",
								"GModTower/virus/weapons/SonicDispersionShotgun/alt_shoot2.wav" }

SWEP.SoundReload			= "GModTower/virus/weapons/SonicDispersionShotgun/reload.wav"
SWEP.SoundEmpty		 		= "GModTower/virus/weapons/SonicDispersionShotgun/empty.wav"
SWEP.SoundDeploy			= "GModTower/virus/weapons/SonicDispersionShotgun/deploy.wav"
SWEP.ExtraSounds			= { ["Charge"] = "GModTower/virus/weapons/SonicDispersionShotgun/alt_chargestart.wav",
								["Empty"] = "GModTower/virus/weapons/SonicDispersionShotgun/alt_empty.wav" }
