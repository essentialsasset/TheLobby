...
surface.CreateFont( "GModToolScreen",{ font = "coolvetica", size = 82, weight = 500, antialias = true, additive = false })
...
function SWEP:ViewModelDrawn()
	...
	DrawScrollingText( LocalPlayer()._InvSaveName or "CHOOSE SAVE NAME!" , 64, TEX_SIZE )
