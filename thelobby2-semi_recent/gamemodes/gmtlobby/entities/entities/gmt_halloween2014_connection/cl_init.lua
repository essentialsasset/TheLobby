...
local OffsetUp = 170
local OffsetRight = 90
local OffsetForward = 0
local BoardWidth = 1164
local BoardHeight = 1164
...
usermessage.Hook( "OpenHalloweenConnection", function( um ) 
	...
	Derma_Query( 
		...
		"Yes - Leave the Lobby", function() LocalPlayer():ConCommand('connect ip') end,
		"No, I'm not ready to leave", EmptyFunction
	)
