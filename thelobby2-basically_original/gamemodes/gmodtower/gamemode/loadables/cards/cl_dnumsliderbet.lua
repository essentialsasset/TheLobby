...
surface.CreateFont( "BetSlider", { font = "Bebas Neue", size = 18, weight = 500 } )
...
function PANEL:Paint( w, h )
	...
	surface.SetDrawColor( Color( 85, 85, 85, 80 ) )

	surface.DrawRect( 3, ( self:GetTall() / 2 ) + 6, self:GetWide() - 6, 1 )
...
derma.DefineControl( "DNumSliderBet", "A simple slider", PANEL, "Panel" )