...
function GTowerHatAdmin:RequestUpdate()
	...
	if !HatTable[ModelName] then
		HatTable[ModelName] = {}
	end

	if !HatTable[ModelName][HatName] then
		HatTable[ModelName][HatName] = {}
	end

	HatTable[ModelName][HatName] = {
		Vector(GTowerHatAdmin.ValuesList[1]:GetValue(),GTowerHatAdmin.ValuesList[2]:GetValue(),GTowerHatAdmin.ValuesList[3]:GetValue()),
		Angle(GTowerHatAdmin.ValuesList[4]:GetValue(),GTowerHatAdmin.ValuesList[5]:GetValue(),GTowerHatAdmin.ValuesList[6]:GetValue()),
...
function PANEL:SetModel( strModelName )
	...
	if strModelName == "models/uch/pigmask.mdl" or strModelName == "models/uch/mghost.mdl" then
		self.HeadPos = self.Entity:GetPos()
		if strModelName == "models/uch/pigmask.mdl" then
			self.Entity:SetSequence("idle")
		else
			self.Entity:SetSequence("null")
		end
		self:SetLookAt( self.Entity:GetPos() )
		self:ResetCamera()
		return
	end
