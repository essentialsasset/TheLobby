...
GTowerHats.AttachmentsList = {
	[GTowerHats.Attachments.EYES] = {
		Name = "Eyes",
		Key = "eyes",
		IsBone = false
	},
	[GTowerHats.Attachments.Spine] = {
		Name = "Spine",
		Key = "ValveBiped.Bip01_Spine2",
		IsBone = true
	},
	[GTowerHats.Attachments.Pelvis] = {
		Name = "Pelvis",
		Key = "ValveBiped.Bip01_Pelvis",
		IsBone = true
	},
	[GTowerHats.Attachments.RHand] = {
		Name = "Right Hand",
		Key = "ValveBiped.Bip01_R_Hand",
		IsBone = true
	},
	[GTowerHats.Attachments.RFoot] = {
		Name = "Right Foot",
		Key = "ValveBiped.Bip01_R_Foot",
		IsBone = true
	},
	[GTowerHats.Attachments.LHand] = {
		Name = "Left Hand",
		Key = "ValveBiped.Bip01_L_Hand",
		IsBone = true
	},
	[GTowerHats.Attachments.LFoot] = {
		Name = "Left Foot",
...
/*table.insert( GTowerHats.Hats, {
	Name = "Horns",
	description = "This hat will make you horny.  Literally.",
	unique_Name = "hathornhat",
	price = 150,
	model = "models/gmod_tower/hornhat.mdl"
} )*/
...
table.insert( GTowerHats.Hats, {
	Name = "Pilgram Hat",
	description = "Celebrate Thanksgiving by wearing this hat.",
	unique_Name = "pilgramhat",
	price = 350,
...
table.insert( GTowerHats.Hats, {
	Name = "Toeto Hat",
	description = "e-to e-toeto ~Red-faced toeto",
...
table.insert( GTowerHats.Hats, {
	Name = "3D Glasses",
	description = "Now you can play GMT... in 3D!!!",
