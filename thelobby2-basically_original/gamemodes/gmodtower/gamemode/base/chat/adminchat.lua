...
AddCombineLine( "Affirmative 2", "npc/metropolice/vo/affirmative2.wav" );
...
AddCombineLine( "Investigating 10-103", "npc/metropolice/vo/investigating10-103.wav" );
...
AddCombineLine( "This is your second warning", "npc/metropolice/vo/thisisyoursecondwarning.wav" );
