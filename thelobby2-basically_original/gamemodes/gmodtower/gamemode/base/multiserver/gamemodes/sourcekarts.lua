...
function GMode:ProcessData( ent, data )
	...
	local Laps = string.format( "%d <color=white>/</color> %d", CurLap, MaxLaps )
	...
	local Rounds = string.format( "%d <color=white>/</color> %d", CurRound, MaxRounds )

	// Parse and set position
	ent.TimeLeftTitle = markup.Parse( "<font=MultiSubDeluxe><color=white>LAP</color></font>" )
	ent.TimeLeftMarkup = markup.Parse( "<font=MultiSubDeluxe>" .. Laps .. "</font>" )
	...
	ent.RoundsTitle = markup.Parse( "<font=MultiSubDeluxe><color=white>TRACK</color></font>" )
	ent.RoundsMarkup = markup.Parse( "<font=MultiSubDeluxe>" .. Rounds .. "</font>" )
