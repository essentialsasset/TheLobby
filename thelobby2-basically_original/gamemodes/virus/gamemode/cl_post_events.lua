...
local function facilityPost( mul, time )	
	...
	layer.contrast = 1.21
	layer.color = .9
	postman.AddColorLayer( "gmt_virus_facility201", layer )

end
AddPostEvent( "gmt_virus_facility201", facilityPost )
...
local function lostarenaPost( mul, time )
	...
	layer.contrast = 0.75
	layer.color = 0.87
	postman.AddColorLayer( "gmt_virus_lostarena01", layer )

end
AddPostEvent( "gmt_virus_lostarena01", lostarenaPost )
...
local function ripostePost( mul, time )
	...
	layer.contrast = 1.32
	layer.color = 0.87
	postman.AddColorLayer( "gmt_virus_riposte01", layer )

end
AddPostEvent( "gmt_virus_riposte01", ripostePost )
...
local function swampPost( mul, time )
	...
	layer.contrast = 0.53
	layer.color = 0.87
	postman.AddColorLayer( "gmt_virus_swamp01", layer )

end
AddPostEvent( "gmt_virus_swamp01", swampPost )
...
local function swamplightPost( mul, time )
	...
	layer.contrast = 0.98
	layer.color = 0.83
	postman.AddColorLayer( "gmt_virus_swamplight01", layer )

end
AddPostEvent( "gmt_virus_swamplight01", swamplightPost )
