...
function EFFECT:Init(data)
	...
	for i=1, 5 do
		local particle = emitter:Add("particles/flamelet3", Pos + Vector(math.random(-20,20),math.random(-20,20),math.random(0,5)))
	...
	for i=1, 13 do
		local particle = emitter:Add("particles/flamelet3", Pos + Vector(math.random(-15,15),math.random(-15,15),math.random(0,5)))
		particle:SetVelocity(Vector(math.random(-6,16),math.random(-6,16),math.random(15,40)))
		particle:SetDieTime(math.Rand(0.5, 0.6))
		particle:SetStartAlpha(math.Rand(220, 240))
		particle:SetStartSize(5)
	...
	for i=1, 5 do
		local particle = emitter:Add("particles/flamelet3", Pos + Vector(math.random(-10,10),math.random(-10,10),math.random(0,5)))
		particle:SetVelocity(Vector(math.random(-6,16),math.random(-6,16),math.random(15,40)))
		particle:SetDieTime(math.Rand(0.5, 0.6))
		particle:SetStartAlpha(math.Rand(220, 240))
		particle:SetStartSize(5)
